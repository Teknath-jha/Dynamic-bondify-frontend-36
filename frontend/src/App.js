...
import Trade from './component/Admin/Trade';
import PostMatured from './component/Security/Postmatured';
import MySecurities from './component/MySecurity/MySecurities';
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route exact path='/' element={<AdminRoute />}>
          ...
          <Route exact path="/securities/get" element={<SecurityList />} />
          <Route exact path="/admin/trades" element={<Trade />} />
          <Route exact path="/admin/postmatured" element={<PostMatured />} />
          <Route exact path="/admin/mysecurities" element={<MySecurities />} />
        </Route>
